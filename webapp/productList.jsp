...
%>
		<a href="eventProduct.jsp?category=<%=category %>&categoryNum=<%=categoryNum %>"> <img src = "images/<%=category %>.jpg"></a>
<%
	}else{ //배너이미지가 존재하지 않으면 이벤트 배너 띄우기
%>
		<a href="eventNow.jsp?category=추석"> <img src = "images/이벤트.jpg"></a>
<% } %>
